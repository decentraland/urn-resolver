...
function testFor(urn: string, contentUrl: string | null, options?: ResolversOptions) {
  test(urn, async () => {
...
describe('Content url generation', function () {
  testFor('decentraland:off-chain:something:something-else', null)
  testFor(
  ...
  testFor('urn:decentraland:ethereum:collections-v1:base-avatars:eyes_03', null)
